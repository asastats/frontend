...
[wallet-frontend](../../README.md) / [evmConnectors](../README.md) / discoverInjectedConnectors
...
Defined in: [evmConnectors.ts:34](https://github.com/asastats/frontend/blob/main/wallet/src/evmConnectors.ts#L34)
