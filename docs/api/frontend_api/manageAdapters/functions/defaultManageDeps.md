...
[wallet-frontend](../../README.md) / [manageAdapters](../README.md) / defaultManageDeps

# Function: defaultManageDeps()

> **defaultManageDeps**(`options`): [`ManageDeps`](../../manageAddressesComponent/interfaces/ManageDeps.md)

Defined in: [manageAdapters.ts:139](https://github.com/asastats/frontend/blob/main/wallet/src/manageAdapters.ts#L139)
