"""Testing module for :py:mod:`walletauth.apps` module."""
...
class TestWalletauthApps:
    ...
    def test_walletauth_apps_walletauthconfig_default_auto_field(self):
        assert WalletauthConfig.default_auto_field == "django.db.models.BigAutoField"
