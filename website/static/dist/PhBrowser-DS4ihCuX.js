import{a as r,i as l,n,o as g,r as c,t as p}from"./property-0uRvRiuU.js";var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,s=(a,o,H,i)=>{for(var e=i>1?void 0:i?Z(o,H):o,V=a.length-1,h;V>=0;V--)(h=a[V])&&(e=(i?h(o,H,e):h(e))||e);return i&&e&&d(o,H,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return l`<svg
  ...
  `;s([p({type:String,reflect:!0})],t.prototype,"size",2);s([p({type:String,reflect:!0})],t.prototype,"weight",2);s([p({type:String,reflect:!0})],t.prototype,"color",2);s([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([n("ph-browser")],t);export{t as PhBrowser};
