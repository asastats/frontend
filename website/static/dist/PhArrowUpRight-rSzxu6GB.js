import{a as r,i as g,n as d,o as c,r as w,t as p}from"./property-0uRvRiuU.js";var u=Object.defineProperty,L=Object.getOwnPropertyDescriptor,o=(a,s,h,i)=>{for(var e=i>1?void 0:i?L(s,h):s,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(i?n(s,h,e):n(e))||e);return i&&e&&u(s,h,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-arrow-up-right")],t);export{t as PhArrowUpRight};
