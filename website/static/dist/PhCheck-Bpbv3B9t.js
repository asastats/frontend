import{a as e,i as g,n as c,o as d,r as u,t as s}from"./property-0uRvRiuU.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,h,i)=>{for(var r=i>1?void 0:i?y(l,h):l,p=a.length-1,n;p>=0;p--)(n=a[p])&&(r=(i?n(l,h,r):n(r))||r);return i&&r&&w(l,h,r),r},t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-check")],t);export{t as PhCheck};
