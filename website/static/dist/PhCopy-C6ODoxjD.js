import{a as e,i as l,n,o as g,r as c,t as s}from"./property-0uRvRiuU.js";var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,H=(r,o,i,V)=>{for(var a=V>1?void 0:V?Z(o,i):o,h=r.length-1,p;h>=0;h--)(p=r[h])&&(a=(V?p(o,i,a):p(a))||a);return V&&a&&d(o,i,a),a},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var r;return l`<svg
  ...
  `;H([s({type:String,reflect:!0})],t.prototype,"size",2);H([s({type:String,reflect:!0})],t.prototype,"weight",2);H([s({type:String,reflect:!0})],t.prototype,"color",2);H([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=H([n("ph-copy")],t);export{t as PhCopy};
