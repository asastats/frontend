import{a as e,i as g,n as v,o as c,r as d,t as i}from"./property-0uRvRiuU.js";var H=Object.defineProperty,V=Object.getOwnPropertyDescriptor,s=(r,h,p,o)=>{for(var a=o>1?void 0:o?V(h,p):h,l=r.length-1,n;l>=0;l--)(n=r[l])&&(a=(o?n(h,p,a):n(a))||a);return o&&a&&H(h,p,a),a},t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var r;return g`<svg
  ...
  `;s([i({type:String,reflect:!0})],t.prototype,"size",2);s([i({type:String,reflect:!0})],t.prototype,"weight",2);s([i({type:String,reflect:!0})],t.prototype,"color",2);s([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([v("ph-plus")],t);export{t as PhPlus};
