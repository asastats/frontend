import{a as r,i as g,n as d,o as c,r as w,t as i}from"./property-0uRvRiuU.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,p,s)=>{for(var e=s>1?void 0:s?y(l,p):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(s?n(l,p,e):n(e))||e);return s&&e&&u(l,p,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-arrow-up")],t);export{t as PhArrowUp};
