import{a as r,i as g,n as d,o as c,r as w,t as s}from"./property-0uRvRiuU.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,l=(a,o,p,i)=>{for(var e=i>1?void 0:i?y(o,p):o,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(i?n(o,p,e):n(e))||e);return i&&e&&u(o,p,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;l([s({type:String,reflect:!0})],t.prototype,"size",2);l([s({type:String,reflect:!0})],t.prototype,"weight",2);l([s({type:String,reflect:!0})],t.prototype,"color",2);l([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([d("ph-caret-down")],t);export{t as PhCaretDown};
