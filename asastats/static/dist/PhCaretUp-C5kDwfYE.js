import{a as r,i as g,n as d,o as c,r as u,t as i}from"./property-0uRvRiuU.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,s=(a,o,p,l)=>{for(var e=l>1?void 0:l?y(o,p):o,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(l?n(o,p,e):n(e))||e);return l&&e&&w(o,p,e),e},t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;s([i({type:String,reflect:!0})],t.prototype,"size",2);s([i({type:String,reflect:!0})],t.prototype,"weight",2);s([i({type:String,reflect:!0})],t.prototype,"color",2);s([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([d("ph-caret-up")],t);export{t as PhCaretUp};
