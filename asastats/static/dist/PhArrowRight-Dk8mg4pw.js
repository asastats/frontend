import{a as r,i as n,n as d,o as c,r as w,t as l}from"./property-0uRvRiuU.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,s,h,i)=>{for(var e=i>1?void 0:i?y(s,h):s,p=a.length-1,g;p>=0;p--)(g=a[p])&&(e=(i?g(s,h,e):g(e))||e);return i&&e&&u(s,h,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return n`<svg
  ...
  `;o([l({type:String,reflect:!0})],t.prototype,"size",2);o([l({type:String,reflect:!0})],t.prototype,"weight",2);o([l({type:String,reflect:!0})],t.prototype,"color",2);o([l({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-arrow-right")],t);export{t as PhArrowRight};
